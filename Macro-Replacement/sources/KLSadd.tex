...
Following \myciteKLS{72}{(4.39)} and \mycite{GR}{(7.5.43)}
...
%
\paragraph{History}
The affine $q$-Krwtchouk polynomials were considered by Delsarte \myciteKLS{161}{Theorem~11}, \cite[(16)]{K23}
...
\begin{equation}
\wt h_n(x;q)=x^n \qhypK21{q^{-n},q^{-n+1}}0{q^2,-q^2 x^{-2}}.
\label{143}
\end{equation}
%
