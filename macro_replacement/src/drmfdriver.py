...
def main():
    ...
    parser.add_option(
        ...
        dest="replace",
        callback=validate,
        help="make replacements from input file write them to the output file [default]")
    parser.add_option(
        "-s",
        "--search",
        default=False,
        ...
        dest="search",
        callback=validate,
        help="write a log of replacemnts that should be made in the input file to the output file (including line numbers)")
    ...
    parser.add_option(
        ...
        default=False,
        dest="verbose",
        help="print out information about replacements as they occur")

    parser.add_option(
        "-c",
        "--config",
        action="store",
        default="function_regex",
    ...
    func_list = ConfigFile(
        options.config_file_name,
        verbose=options.verbose).all_funcs
